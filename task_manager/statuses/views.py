...
class StatusDeleteView(CustomLoginRequiredMixin, ErrorCatcherMixin,
    ...
    error_message = _("Status can't be deleted, because it is in use")
    error_redirect_name = reverse_lazy('status_list')
